# Generated by Django 5.1.3 on 2024-12-31 18:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='quizzApp.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
            fields=[
                ...
                ('quiz_participent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='quizzApp.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='ResponseParticipent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('select_option', models.CharField(max_length=200)),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='quizzApp.participant')),
                ('question_response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizzApp.question')),
            ],
        ),
        migrations.CreateModel(
            name='Suggestion',
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suggestions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
